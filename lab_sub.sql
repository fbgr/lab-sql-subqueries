...
SELECT count(film_id) as n_hunchback
FROM INVENTORY
...
FROM sakila.film_actor INNER JOIN sakila.film USING (film_id) WHERE title = "Alone Trip");
...
-- I don't know if this is wrong but I see that all the customer did a payment at least once greater than the average,
-- so I end up retrieving all the customers.
SELECT * 
